...
{
    public class clsCenCosCarlos : clsBase, IDisposable
    {
        ...
        //*
        //************************************************************
        public clsCenCosCarlos()
        {
            mstrTableName = "ctbCenCos";
            mstrClassName = "clsCenCosCarlos";

            PropertyInit();
            FilterInit();
        }

        public clsCenCosCarlos(string ConnectString) : this()
        {
        ...
        public clsCenCosCarlos(SqlConnection oConnection) : this()
        {
            moConnection = oConnection;
        }

        public clsCenCosCarlos(SqlConnection oConnection, SelectFilters bytSelectFilter) : this()
        {
            moConnection = oConnection;
            mintSelectFilter = bytSelectFilter;
        }

        public clsCenCosCarlos(SqlConnection oConnection, SelectFilters bytSelectFilter, WhereFilters bytWhereFilter) : this()
        {
            moConnection = oConnection;
            mintSelectFilter = bytSelectFilter;
        ...
        public clsCenCosCarlos(SqlConnection oConnection, SelectFilters bytSelectFilter, WhereFilters bytWhereFilter, OrderByFilters bytOrderByFilter) : this()
        {
            moConnection = oConnection;
            mintSelectFilter = bytSelectFilter;
            mintWhereFilter = bytWhereFilter;
            ...
            switch (mintUpdateFilter)
            {
                case UpdateFilters.All:
                    ...
                    moParameters = new SqlParameter[7] {
                        ...
                        new SqlParameter(clsCenCosVM._CenCosId, SqlDbType.Int),
                        new SqlParameter(clsCenCosVM._CenCosCod, VM.CenCosCod),
                        new SqlParameter(clsCenCosVM._CenCosDes, VM.CenCosDes),
                        new SqlParameter(clsCenCosVM._CenCosEsp, VM.CenCosEsp),
                        new SqlParameter(clsCenCosVM._CenCosGrupoId, VM.CenCosGrupoId),
        ...
        public override bool Validate()
        {
            ...
            {
                strMsg += "Descipción del Centro de Costo es Requerido" + Environment.NewLine;
            }
